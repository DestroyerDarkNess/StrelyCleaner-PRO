...
#Region "Functions"
    ...
    Public Function RoundRectangle(ByVal rect As Rectangle, Optional r! = 0.3, Optional TL As Boolean = True, Optional TR As Boolean = True, Optional BR As Boolean = True, Optional BL As Boolean = True) As GraphicsPath
        Return RoundRect(rect.X, rect.Y, rect.Width, rect.Height, r!, TL, TR, BR, BL)
    End Function
