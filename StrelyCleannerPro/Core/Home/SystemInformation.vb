...
Namespace Core.Home
    ...
    Public Class SystemInformation
        ...
        Public Shared Async Function GetAntiVirus() As Task(Of String)
        ...
        Public Shared Async Function GetFirewall() As Task(Of String)
            Dim str As String = Nothing
        ...
        Public Shared Async Function GetComputerInformation() As Task(Of String)
        ...
        Private Shared Function ram() As String
            Return "RAM " & Math.Round((My.Computer.Info.TotalPhysicalMemory) / 1073741824).ToString()
        End Function
