...
#End Region
    ...
    Public Function Unsecure_Initialize(Optional ByVal UseCustomParentHandle As Boolean = False, Optional AppArgs As String = "") As Boolean
        Try
            If IsConsoleParent() = False Then

                Dim CmdArgs As String = "/c @echo off & Title ConsoleHost:StrelyCleaner & echo/ & echo Starting Antimalware Engine and Tools  & echo/ & echo Old SourceCode: https://github.com/DestroyerDarkNess/Strely-Pro & echo/ & echo Engine: https://github.com/DestroyerDarkNess/XylonV2 & " &
                    """" & Get_Current_APP_Path() & """" & " " & AppArgs & " 2>&1 & End" '"/c @echo off & Title ConsoleHost & cls & Call " & """" & Get_Current_APP_Path() & """" & " " & AppArgs '"/k @echo off & Title ConsoleHost & cls & Call " & """" & Get_Current_APP_Path() & """" ' & " & End"
